...
public class curve_generator
{
    ...
    {
        PointF start = new PointF(-10f, 30.0f);
        PointF end = new PointF(-100f, 0.0f);
        float angle = 100f;
        float period = 3f;
        ...
        angle is float of degrees of flex
        the first boolean represents convex or concave in this case true is concave with respect to north
        the next boolean represents the side of inflection
        angle is the angle of reflection
        period is the relative frequency of the points
        */
        List<PointF> points = generateCurve(start, end, angle, period, true, false);
